...
const FACEBOOK = 'https://facebook.com/visionlarimoveis'
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50 flex flex-col items-center gap-2.5">
      ...
      <a
        ...
        title="WhatsApp"
        className="w-14 h-14 rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform"
      ...
      <a
        ...
        style={{ background: 'linear-gradient(135deg, #1877F2, #0d5db8)' }}
      >
